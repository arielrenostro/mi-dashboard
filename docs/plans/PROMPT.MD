...
1.1. leia as seções de tarefas abaixo, elas podem estar em contradição ou mencionar comportamentos que impactem outras seções. Revise-as, ajuste conteúdos faltantes presentes em outras seções e pergunte ao usuário a respeito de contradições;
1.2. Documente elas num arquivo MD "0001-request-revision".
1.3. Confronte estas especificações com as especificações do projeto. Procure por contradições, conflitos, itens faltantes e possíveis problemas. Sempre pergunte ao usuário o que deseja escolher;
1.4. Documente o resultado num arquivo MD "0002-spec-revision";
